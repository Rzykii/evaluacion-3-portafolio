...
<div class="container-fluid mb-5 py-5 bg-light" id="Habilidades">
  ...
  <div class="row g-3 px-3">
    <div class="col-sm-3">
      <div class="card border-0 rounded-4 shadow-sm">
        <div class="card-body text-center py-4">
          <img src="assets/img/html.png" alt="html" width="40" height="40" class="mx-auto d-block mb-2">
          <div class="fw-bold mb-2">HTML</div>
          <span class="badge rounded-pill text-secondary border" style="background-color:#f0f2f5;font-weight:500;">Frontend</span>
        </div>         
      </div>
    </div>
    <div class="col-sm-3">
      <div class="card border-0 rounded-4 shadow-sm">
        <div class="card-body text-center py-4">
          <img src="assets/img/css-3.png" alt="CSS" width="40" height="40" class="mx-auto d-block mb-2">
    ...
    <div class="col-sm-3">
      <div class="card border-0 rounded-4 shadow-sm">
        <div class="card-body text-center py-4">
          <img src="assets/img/js.png" alt="JS" width="40" height="40" class="mx-auto d-block mb-2">
    ...
    <div class="col-sm-3">
      <div class="card border-0 rounded-4 shadow-sm">
        <div class="card-body text-center py-4">
          <img src="assets/img/letras-del-alfabeto.png" alt="bootstrap" width="40" height="40" class="mx-auto d-block mb-2">
    ...
    <div class="col-sm-3">
      <div class="card border-0 rounded-4 shadow-sm">
        <div class="card-body text-center py-4">
          <img src="assets/img/php.png" alt="php" width="40" height="40" class="mx-auto d-block mb-2">
          <div class="fw-bold mb-2">PHP</div>
          <span class="badge rounded-pill text-secondary border" style="background-color:#f0f2f5;font-weight:500;">Backend</span>
        </div>         
      </div>
    </div>
    <div class="col-sm-3">
      <div class="card border-0 rounded-4 shadow-sm">
        <div class="card-body text-center py-4">
          <img src="assets/img/mysql.png" alt="mysql" width="40" height="40" class="mx-auto d-block mb-2">
          <div class="fw-bold mb-2">MySQL</div>
          <span class="badge rounded-pill text-secondary border" style="background-color:#f0f2f5;font-weight:500;">Database</span>
        </div>         
      </div>
    </div>
    <div class="col-sm-3">
      <div class="card border-0 rounded-4 shadow-sm">
        <div class="card-body text-center py-4">
          <img src="assets/img/nodejs.png" alt="nodejs" width="40" height="40" class="mx-auto d-block mb-2">
    ...
    <div class="col-sm-3">
      <div class="card border-0 rounded-4 shadow-sm">
        <div class="card-body text-center py-4">
          <img src="assets/img/github.png" alt="github" width="40" height="40" class="mx-auto d-block mb-2">
          <div class="fw-bold mb-2">GitHub</div>
          <span class="badge rounded-pill text-secondary border" style="background-color:#f0f2f5;font-weight:500;">Tools</span>
        </div>         
      </div>
    </div>
  </div>
  ...
  <div class="row g-4">
    <div class="col-sm-6">
      <div class="card border-0 rounded-4 shadow">
        <div class="card-body bg-light fw-bold p-4">Frontend
          <div class="progress mt-2 mb-3" style="height:3px">
            <div class="progress-bar" style="width:100%;"></div>
          </div>
          <p class="fw-bold mb-1">🌐 HTML</p>
          <div class="progress mb-3">
            <div class="progress-bar" style="width:95%">95%</div>
          </div>
          <p class="fw-bold mb-1">🎨 CSS</p>
          <div class="progress mb-3">
          ...
          <p class="fw-bold mb-1">🅱️ Bootstrap</p>
          <div class="progress">
            <div class="progress-bar" style="width:90%">90%</div>
          </div>
        </div>
    ...
    <div class="col-sm-6">
      <div class="card border-0 rounded-4 shadow">
        <div class="card-body bg-light fw-bold p-4">Backend
          <div class="progress mt-2 mb-3" style="height:3px">
          ...
          <p class="fw-bold mb-1">🟢 Node.js</p>
          <div class="progress">
            <div class="progress-bar bg-success" style="width:80%">80%</div>
          </div>
        </div>
    ...
    <div class="col-sm-6">
      <div class="card border-0 rounded-4 shadow">
        <div class="card-body bg-light fw-bold p-4">Database
          <div class="progress mt-2 mb-3" style="height:3px">
            <div class="progress-bar bg-info" style="width:100%;"></div>
          </div>
          <p class="fw-bold mb-1">🗄️ MySQL</p>
          <div class="progress">
    ...
    <div class="col-sm-6">
      <div class="card border-0 rounded-4 shadow">
        <div class="card-body bg-light fw-bold p-4">Tools
          <div class="progress mt-2 mb-3" style="height:3px">
...
<div class="container-fluid py-5 bg-light" id="Proyectos">
  ...
  <div class="row g-4 px-3 mb-5">
    <div class="col-sm-4">
      <div class="card shadow-sm border-0 rounded-4 h-100">
        <div class="project-img">
          <img class="card-img-top" src="assets/img/HD-wallpaper-code-text-programming-coding-thumbnail.jpg" alt="E-commerce">
        </div>
        <div class="card-body">
          ...
          <a href="#" class="btn btn-outline-secondary"><i class="bi bi-github"></i> Código</a>
        </div>
      </div>
    </div>
    <div class="col-sm-4">
      <div class="card shadow-sm border-0 rounded-4 h-100">
        <div class="project-img">
          <img class="card-img-top" src="assets/img/HD-wallpaper-microchip-neon-lines-black-background-chips-technology-backgrounds-thumbnail.jpg" alt="Task app">
        </div>
        <div class="card-body">
    ...
    <div class="col-sm-4">
      <div class="card shadow-sm border-0 rounded-4 h-100">
        <div class="project-img">
          <img class="card-img-top" src="assets/img/thumbnail-template-tech-world-background-226926.jpg" alt="Weather">
        </div>
        <div class="card-body">
  ...
  <h3 class="text-center fw-bold mt-5" id="Contacto">Formulario de contacto</h3>
  <p class="text-center py-3 text-muted">¿Tienes algún proyecto en mente? ¡Contáctame y trabajemos juntos!</p><br>
        ...
        <form id="contactForm" novalidate>
          <div class="row g-4">
            ...
            <div class="col-12">
              ...
              <input type="text" class="form-control" placeholder="¿Sobre qué quieres hablar?" name="asunto">
            </div>
            <div class="col-12">
              <label class="form-label" for="comment"><i class="bi bi-chat-left"></i> Mensaje</label>
              <textarea class="form-control" placeholder="Escribe tu mensaje aquí..." rows="5" id="comment" name="mensaje"></textarea>
            </div>
            <div class="col-12">
  ...
  <div class="container">
    <div class="row gy-5">
      <div class="col-lg-4 col-md-6">
        ...
        <p>Desarrollador Full Stack especializado en crear experiencias web modernas y funcionales.</p>
      </div>        
      <div class="col-lg-4 col-md-6">
        <h5>Contacto</h5>
        <div class="contact-item">
